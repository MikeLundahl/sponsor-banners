...
flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().initializers.add('mbl/sponsor-banners', function () {
  console.log('[mbl/sponsor-banners] Hello, admin!');
  flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().extensionData["for"]('mbl-sponsor-banners').registerSetting({
